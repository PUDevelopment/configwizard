# configwizard - leírás [![Build Status](https://jenkins.playerunion.eu/job/configwizard/lastBuild/badge/icon)](https://jenkins.playerunion.eu/job/configwizard/lastBuild/)
